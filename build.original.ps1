...
task AssertRequiredModules {
    ...
    & $AssertModule Pester 5.3.3 -Force:$Force.IsPresent
    & $AssertModule ugit 0.3.6 -Force:$Force.IsPresent
    & $AssertModule PipeScript 0.2.1 -Force:$Force.IsPresent
    & $AssertModule PSReadLine 2.2.6 -Force:$Force.IsPresent
